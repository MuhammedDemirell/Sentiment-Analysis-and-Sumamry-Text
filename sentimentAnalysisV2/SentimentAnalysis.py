...
def predictSentiment():
    ...
    trainData, testData, trainLabels, testLabels = train_test_split(dataArray, data["sentiment"], test_size=0.80, random_state=33)
    ...
    filePathSummary="UserText.txt"
    # Tahmin yapma
    with open(filePathSummary,
              mode='r') as file:
        text = file.read()
